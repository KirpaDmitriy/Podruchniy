...
from ml.hypotheses_generator import get_hypotheses
...
async def hypotheses_list(data_id: str):
    answer = []
    for hypothesis in get_hypotheses(load_data_file(get_data_path(data_id))):
        ...
        save_hypothesis(hypo_id, hypothesis)
    return answer
